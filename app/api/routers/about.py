...
from app.services.about import create_item_service, list_items_service, get_item_service, update_item_service, delete_item_service
router = APIRouter()
...
@router.get("/", response_model=List[AboutOut])
...
@router.get("/{item_id}", response_model=AboutOut)
